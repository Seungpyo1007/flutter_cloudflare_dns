<p align="center">
  <img src="assets/flutter_cloudflare_dns-hero.png" alt="flutter_cloudflare_dns — Cloudflare DNS toolkit for Android" width="100%">
</p>
...
> **Platform support:** version 0.0.2 officially supports Android only. Other
> Flutter platforms are planned, but are not part of the current support policy.

## Android demo

<p align="center">
  <img src="assets/flutter_cloudflare_dns-demo.webp" alt="Animated Android demo showing the DNS dashboard and SRV record editor" width="320">
</p>
